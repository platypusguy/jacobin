...
- Type in this: debug.TVO(obj)
- Press return. This yields a new variable "result" set = a long complex Go string with embedded newline characters.
...
- Position into the "Evaluate expression" windows.
- Type in this: debug.STR(jstr)
- Press return. This yields a new variable "result" with the expected result.
