...
// Load_Nio_File_Path loads ghelpers.MethodSignatures entries for java.nio.file.Path
func Load_Nio_File_Path() {

	ghelpers.MethodSignatures["java/nio/file/Path.<clinit>()V"] =
	...
	ghelpers.MethodSignatures["java/nio/file/Path.endsWith(Ljava/lang/String;)Z"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: filePathEndsWith}
	ghelpers.MethodSignatures["java/nio/file/Path.endsWith(Ljava/nio/file/Path;)Z"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: filePathEndsWithPath}

	ghelpers.MethodSignatures["java/nio/file/Path.equals(Ljava/lang/Object;)Z"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: filePathEquals}

	// leave getFileSystem ghelpers.Trapped
	ghelpers.MethodSignatures["java/nio/file/Path.getFileSystem()Ljava/nio/file/FileSystem;"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}

	ghelpers.MethodSignatures["java/nio/file/Path.getFileName()Ljava/nio/file/Path;"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: filePathGetFileName}
	ghelpers.MethodSignatures["java/nio/file/Path.getName(I)Ljava/nio/file/Path;"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: filePathGetName}
	ghelpers.MethodSignatures["java/nio/file/Path.getNameCount()I"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: filePathGetNameCount}
	ghelpers.MethodSignatures["java/nio/file/Path.getParent()Ljava/nio/file/Path;"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: filePathGetParent}
	ghelpers.MethodSignatures["java/nio/file/Path.getRoot()Ljava/nio/file/Path;"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: filePathGetRoot}

	ghelpers.MethodSignatures["java/nio/file/Path.hashCode()I"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: filePathHashCode}

	ghelpers.MethodSignatures["java/nio/file/Path.isAbsolute()Z"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: filePathIsAbsolute}

	ghelpers.MethodSignatures["java/nio/file/Path.iterator()Ljava/util/Iterator;"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: filePathIterator}
	...
	ghelpers.MethodSignatures["java/nio/file/Path.resolve(Ljava/lang/String;)Ljava/nio/file/Path;"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: filePathResolve}
	ghelpers.MethodSignatures["java/nio/file/Path.resolve(Ljava/nio/file/Path;)Ljava/nio/file/Path;"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: filePathResolvePath}

	ghelpers.MethodSignatures["java/nio/file/Path.resolveSibling(Ljava/lang/String;)Ljava/nio/file/Path;"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: filePathResolveSibling}
	ghelpers.MethodSignatures["java/nio/file/Path.resolveSibling(Ljava/nio/file/Path;)Ljava/nio/file/Path;"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: filePathResolveSiblingPath}

	ghelpers.MethodSignatures["java/nio/file/Path.startsWith(Ljava/lang/String;)Z"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: filePathStartsWith}
	ghelpers.MethodSignatures["java/nio/file/Path.startsWith(Ljava/nio/file/Path;)Z"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: filePathStartsWithPath}

	ghelpers.MethodSignatures["java/nio/file/Path.subpath(II)Ljava/nio/file/Path;"] =
		ghelpers.GMeth{ParamSlots: 2, GFunction: filePathSubpath}

	ghelpers.MethodSignatures["java/nio/file/Path.toAbsolutePath()Ljava/nio/file/Path;"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: filePathToAbsolutePath}
	ghelpers.MethodSignatures["java/nio/file/Path.toFile()Ljava/io/File;"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	...
	ghelpers.MethodSignatures["java/nio/file/Path.register(Ljava/nio/file/WatchService;[Ljava/nio/file/WatchEvent$Kind;)Ljava/nio/file/WatchKey;"] =
...
func filePathGetName(params []interface{}) interface{} {
	...
	if i < 0 || int(i) >= len(parts) {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "Path.getName: index out of bounds")
	}
...
func filePathRelativize(params []interface{}) interface{} {
	...
	if isAbsolute(thisStr) != isAbsolute(otherStr) {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "Path.relativize: both paths must be either absolute or relative")
	}
	...
	if globals.OnWindows {
		...
		if !strings.EqualFold(thisRoot, otherRoot) {
			return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "Path.relativize: both paths must have the same root")
		}
	...
	if err != nil {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "Path.relativize: "+err.Error())
	}
	return newPath(rel)
}
...
func filePathSubpath(params []interface{}) interface{} {
	...
	if start < 0 || end > len(parts) || start >= end {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "Path.subpath: invalid range")
	}
