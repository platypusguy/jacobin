...
func linkedlistRemove(params []interface{}) interface{} {
	...
	if !ok {
		return ghelpers.GetGErrBlk(excNames.ClassCastException, "linkedlistRemove: Invalid self argument")
	}
	elementObj := params[1]
...
func linkedlistRemoveFirst(params []interface{}) interface{} {
	self, ok := params[0].(*object.Object)
	if !ok {
		return ghelpers.GetGErrBlk(excNames.ClassCastException, "linkedlistRemoveFirst: Invalid self argument")
	}
	...
	if llst.Len() == 0 {
		return ghelpers.GetGErrBlk(excNames.NoSuchElementException, "linkedlistRemoveFirst: LinkedList is empty")
	}
...
func linkedlistRemoveLast(params []interface{}) interface{} {
	self, ok := params[0].(*object.Object)
	if !ok {
		return ghelpers.GetGErrBlk(excNames.ClassCastException, "linkedlistRemoveLast: Invalid self argument")
	}
	...
	if llst.Len() == 0 {
		return ghelpers.GetGErrBlk(excNames.NoSuchElementException, "linkedlistRemoveLast: LinkedList is empty")
	}
...
// TODO - How should this really work? ghelpers.Trapped for the moment.
...
func linkedlistSize(params []interface{}) interface{} {
	self, ok := params[0].(*object.Object)
	if !ok {
		return ghelpers.GetGErrBlk(excNames.ClassCastException, "linkedlistSize: Invalid self argument")
	}
	llst, err := ghelpers.GetLinkedListFromObject(self)
	if err != nil {
		return err
