...
func Load_Util_Zip_Crc32_Crc32c() {
	...
	ghelpers.MethodSignatures["java/util/zip/CRC32.<clinit>()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.ClinitGeneric,
		}

	ghelpers.MethodSignatures["java/util/zip/CRC32C.<clinit>()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.ClinitGeneric,
		}
	...
	ghelpers.MethodSignatures["java/util/zip/CRC32C.reset()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  crc32Reset,
		}

	ghelpers.MethodSignatures["java/util/zip/CRC32.update([BII)V"] =
		ghelpers.GMeth{
			ParamSlots: 3,
			GFunction:  crc32UpdateFromArray,
		}

	ghelpers.MethodSignatures["java/util/zip/CRC32C.update([BII)V"] =
		ghelpers.GMeth{
			ParamSlots: 3,
			GFunction:  crc32UpdateFromArray,
		}
	...
	ghelpers.MethodSignatures["java/util/zip/CRC32C.update(I)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  crc32UpdateFromInt,
		}

	ghelpers.MethodSignatures["java/util/zip/CRC32.update(Ljava/nio/ByteBuffer;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/zip/CRC32C.update(Ljava/nio/ByteBuffer;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}
