...
func Load_Util_Hash_Set() {
	...
	ghelpers.MethodSignatures["java/util/HashSet.<clinit>()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.ClinitGeneric,
		}

	ghelpers.MethodSignatures["java/util/HashSet.<init>()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hashmapInit,
		}

	ghelpers.MethodSignatures["java/util/HashSet.<init>(I)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hashmapInit,
		}

	ghelpers.MethodSignatures["java/util/HashSet.<init>(IF)V"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  hashmapInit,
		}

	ghelpers.MethodSignatures["java/util/HashSet.add(Ljava/lang/Object;)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hashsetAdd,
		}

	ghelpers.MethodSignatures["java/util/HashSet.addAll(Ljava/util/Collection;)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HashSet.clear()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hashmapInit,
		}

	ghelpers.MethodSignatures["java/util/HashSet.clone()Ljava/lang/Object;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hashmapInit,
		}

	ghelpers.MethodSignatures["java/util/HashSet.contains(Ljava/lang/Object;)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hashsetContains,
		}

	ghelpers.MethodSignatures["java/util/HashSet.containsAll(Ljava/util/Collection;)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HashSet.isEmpty()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
	...
	ghelpers.MethodSignatures["java/util/HashSet.remove(Ljava/lang/Object;)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hashsetRemove,
		}

	ghelpers.MethodSignatures["java/util/HashSet.removeAll(Ljava/util/Collection;)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HashSet.retainAll(Ljava/util/Collection;)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HashSet.size()I"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hashmapSize,
		}

	ghelpers.MethodSignatures["java/util/HashSet.spliterator()Ljava/util/Spliterator;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HashSet.toArray()[Ljava/lang/Object;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hashsetToArray,
		}

	ghelpers.MethodSignatures["java/util/HashSet.toArray([Ljava/lang/Object;)[Ljava/lang/Object;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}
