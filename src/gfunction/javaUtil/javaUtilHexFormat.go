...
func Load_Util_HexFormat() {
	...
	ghelpers.MethodSignatures["java/util/HexFormat.<clinit>()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hexFormatClinit,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.delimiter()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hfDelimiter,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.equals(Ljava/lang/Object;)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfEquals,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.formatHex([B)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfFormatHexFromBytes,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.formatHex([BII)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 3,
			GFunction:  hfFormatHexFromBytes,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.fromHexDigits(Ljava/lang/CharSequence;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.fromHexDigit(I)I"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfFromHexDigit,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.fromHexDigits(Ljava/lang/CharSequence;II)V"] =
		ghelpers.GMeth{
			ParamSlots: 3,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.fromHexDigitsToLong(Ljava/lang/CharSequence;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.fromHexDigitsToLong(Ljava/lang/CharSequence;II)V"] =
		ghelpers.GMeth{
			ParamSlots: 3,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.hashCode()I"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.of()Ljava/util/HexFormat;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hfOf,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.ofDelimiter(Ljava/lang/String;)Ljava/util/HexFormat;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfOfDelimiter,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.parseHex([CII)[B"] =
		ghelpers.GMeth{
			ParamSlots: 3,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.parseHex(Ljava/lang/CharSequence;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.parseHex(Ljava/lang/CharSequence;II)V"] =
		ghelpers.GMeth{
			ParamSlots: 3,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.prefix()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hfPrefix,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.suffix()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hfSuffix,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.toHexDigits(B)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfByteToHexDigits,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.toHexDigits(C)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfCharToHexDigits,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.toHexDigits(I)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfIntToHexDigits,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.toHexDigits(J)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfLongToHexDigits,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.toHexDigits(JI)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  hfLongToHexDigits,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.toHexDigits(S)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfShortToHexDigits,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.toHighHexDigit(I)C"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfToHighHexDigit,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.toLowHexDigit(I)C"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfToLowHexDigit,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.toString()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hfToString,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.withDelimiter(Ljava/lang/String;)Ljava/util/HexFormat;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfWithDelimiter,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.withLowerCase()Ljava/util/HexFormat;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  hfWithLowerCase,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.withPrefix(Ljava/lang/String;)Ljava/util/HexFormat;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfWithPrefix,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.withSuffix(Ljava/lang/String;)Ljava/util/HexFormat;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  hfWithSuffix,
		}

	ghelpers.MethodSignatures["java/util/HexFormat.withUpperCase()Ljava/util/HexFormat;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
