...
func TestDouble_Coverage(t *testing.T) {
	...
	if blk, ok := doubleCompareTo([]interface{}{d1}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleCompareTo(1) expected IllegalArgumentException")
	}
	if blk, ok := doubleCompareTo([]interface{}{1.0, 2.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
	...
	if blk, ok := doubleToLongBits([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleToLongBits() expected IllegalArgumentException")
	}
	if blk, ok := doubleToLongBits([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleToLongBits(string) expected IllegalArgumentException")
	}
	if blk, ok := doubleToRawLongBits([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleToRawLongBits() expected IllegalArgumentException")
	}
	if blk, ok := doubleToRawLongBits([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleToRawLongBits(string) expected IllegalArgumentException")
	}

	// doubleEquals error paths
	if blk, ok := doubleEquals([]interface{}{d1}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleEquals(1) expected IllegalArgumentException")
	}
	if blk, ok := doubleEquals([]interface{}{1.0, d2}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
	...
	if blk, ok := doubleLongBitsToDouble([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleLongBitsToDouble() expected IllegalArgumentException")
	}
	if blk, ok := doubleLongBitsToDouble([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleLongBitsToDouble(float) expected IllegalArgumentException")
	}

	// doubleMax / doubleMin / doubleSum error paths
	if blk, ok := doubleMax([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleMax(1) expected IllegalArgumentException")
	}
	if blk, ok := doubleMax([]interface{}{1.0, "abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleMax(1, string) expected IllegalArgumentException")
	}
	if blk, ok := doubleMin([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleMin(1) expected IllegalArgumentException")
	}
	if blk, ok := doubleMin([]interface{}{1.0, "abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleMin(1, string) expected IllegalArgumentException")
	}
	if blk, ok := doubleSum([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleSum(1) expected IllegalArgumentException")
	}
	if blk, ok := doubleSum([]interface{}{1.0, "abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleSum(1, string) expected IllegalArgumentException")
	}

	// doubleParseDouble error paths
	if blk, ok := doubleParseDouble([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleParseDouble() expected IllegalArgumentException")
	}
	if blk, ok := doubleParseDouble([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleParseDouble(float) expected IllegalArgumentException")
	}

	// doubleToHexString error paths
	if blk, ok := doubleToHexString([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleToHexString() expected IllegalArgumentException")
	}
	if blk, ok := doubleToHexString([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleToHexString(string) expected IllegalArgumentException")
	}

	// doubleToStringStatic error paths
	if blk, ok := doubleToStringStatic([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleToStringStatic() expected IllegalArgumentException")
	}
	if blk, ok := doubleToStringStatic([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleToStringStatic(string) expected IllegalArgumentException")
	}

	// doubleValueOf error paths
	if blk, ok := doubleValueOf([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleValueOf() expected IllegalArgumentException")
	}
	if blk, ok := doubleValueOf([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleValueOf(string) expected IllegalArgumentException")
	}

	// doubleValueOfString error paths
	if blk, ok := doubleValueOfString([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleValueOfString() expected IllegalArgumentException")
	}
	if blk, ok := doubleValueOfString([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleValueOfString(float) expected IllegalArgumentException")
	}
	sInv := object.StringObjectFromGoString("abc")
	if blk, ok := doubleValueOfString([]interface{}{sInv}).(*GErrBlk); !ok || blk.ExceptionType != excNames.NumberFormatException {
		t.Errorf("doubleValueOfString(abc) expected NumberFormatException")
	}

	// doubleDoubleValue error paths
	if blk, ok := doubleDoubleValue([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleDoubleValue() expected IllegalArgumentException")
	}
	if blk, ok := doubleDoubleValue([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
	...
	if blk, ok := doubleDoubleValue([]interface{}{objCorr}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
	...
	if blk, ok := doubleCompare([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("doubleCompare(1) expected IllegalArgumentException")
	}
	if blk, ok := doubleCompare([]interface{}{1.0, "abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
