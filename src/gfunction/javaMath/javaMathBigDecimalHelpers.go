...
func loadStaticsBigDecimal() {
	...
	_ = statics.AddStatic(types.ClassNameBigDecimal+".INFLATED", statics.Static{Type: types.Long, Value: INFLATED})
...
func addStaticBigDecimal(argName string, argValue int64) {
	...
	ghelpers.InitBigIntegerField(bi, argValue)
...
func setupBasicFields(self, bigIntObj *object.Object, precision, scale int64) {
	...
	self.FieldTable["intCompact"] = object.Field{Ftype: types.Long,
		Fvalue: statics.GetStaticValue(types.ClassNameBigDecimal, "INFLATED")}
}
...
func bigDecimalObjectFromBigInt(bigInt *big.Int, precision, scale int64) *object.Object {
	...
	bigIntObj := object.MakeEmptyObjectWithClassName(&types.ClassNameBigInteger)
...
func BigIntegerFromInt64(arg int64) *object.Object {
	...
	ghelpers.InitBigIntegerField(obj, arg)
	return obj
}
...
func makeBigIntegerFromString(str string) (*object.Object, *ghelpers.GErrBlk) {
	var zz = new(big.Int)
	_, ok := zz.SetString(str, 10)
	if !ok {
		errMsg := fmt.Sprintf("makeBigIntegerFromString: string (%s) not all numerics", str)
		return nil, ghelpers.GetGErrBlk(excNames.NumberFormatException, errMsg)
	}
...
func makeArray2ElemsOfBigDecimal(bd1, bd2 *object.Object) *object.Object {
	ref := "[L" + types.ClassNameBigDecimal + ";"
	arr := []*object.Object{bd1, bd2}
	obj := object.MakePrimitiveObject("["+types.ClassNameBigDecimal, ref, arr)
	return obj
}
