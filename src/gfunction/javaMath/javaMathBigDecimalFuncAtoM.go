...
func bigdecimalAddContext(params []interface{}) interface{} {
	...
	if object.IsNull(mc) {
		return ghelpers.GetGErrBlk(excNames.NullPointerException, "BigDecimal.add(BigDecimal, MathContext): MathContext is null")
	}
...
func bigdecimalByteValueExact(params []interface{}) interface{} {
	...
	if i64 > 127 || i64 < -128 {
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "bigdecimalByteValueExact: out of range for byte value")
	}
...
func bigdecimalDivide(params []interface{}) interface{} {
	...
	// Division by zero
	if b.Sign() == 0 {
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "bigdecimalDivide: divide by zero")
	}
	...
	if after5.Cmp(big.NewInt(1)) != 0 {
		...
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "bigdecimalDivide: non-terminating decimal expansion; no rounding specified")
	}
...
func bigdecimalDivideAndRemainder(params []interface{}) interface{} {
	...
	if drBigInt.Sign() == 0 {
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "bigdecimalDivideAndRemainder: divide by zero")
	}
	...
	if blk, ok := r.(*ghelpers.GErrBlk); ok {
		return blk
	}
	rbd := r.(*object.Object)
...
func bigdecimalDivideToIntegralValue(params []interface{}) interface{} {
	...
	if b.Sign() == 0 {
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "bigdecimalDivideToIntegralValue: divide by zero")
	}
...
func bigdecimalIntValueExact(params []interface{}) interface{} {
	...
	scale := bd.FieldTable["scale"].Fvalue.(int64)
	if scale != int64(0) {
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "bigdecimalIntValueExact: scale is non-zero")
	}
	...
	if int64Value < math.MinInt32 || int64Value > math.MaxInt32 {
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "bigdecimalIntValueExact: value out of int range")
	}
...
func bigdecimalLongValueExact(params []interface{}) interface{} {
	...
	scale := bd.FieldTable["scale"].Fvalue.(int64)
	if scale != int64(0) {
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "bigdecimalLongValueExact: scale is non-zero")
	}
	...
	if int64Value < math.MinInt64 || int64Value > math.MaxInt64 {
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "bigdecimalLongValueExact: value out of long range")
	}
...
func bigdecimalDivideScaleRoundingMode(params []interface{}) interface{} {
	...
	// Validate inputs
	if scaleParam < 0 {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "bigdecimalDivide: negative scale")
	}
	// Per JDK, roundingMode must not be null even if no rounding would be required
	if object.IsNull(rmodeObj) {
		return ghelpers.GetGErrBlk(excNames.NullPointerException, "bigdecimalDivide: RoundingMode is null")
	}
	// Extract unscaled and scales
	dv := dividend.FieldTable["intVal"].Fvalue.(*object.Object)
	dr := divisor.FieldTable["intVal"].Fvalue.(*object.Object)
	...
	if !ok {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "bigdecimalDivide: invalid RoundingMode")
	}
	// UNNECESSARY with non-zero remainder -> ArithmeticException
	if ord == 7 { // UNNECESSARY
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "bigdecimalDivide: rounding necessary")
	}
...
func bigdecimalDivideMathContext(params []interface{}) interface{} {
	...
	mc := params[2].(*object.Object)
	if object.IsNull(mc) {
		return ghelpers.GetGErrBlk(excNames.NullPointerException, "bigdecimalDivide: MathContext is null")
	}
	// Extract rounding mode from MathContext
	rmObj := mconGetRoundingMode([]interface{}{mc}).(*object.Object)
	if object.IsNull(rmObj) {
		return ghelpers.GetGErrBlk(excNames.NullPointerException, "bigdecimalDivide: MathContext.roundingMode is null")
	}
...
func bigdecimalDivideAndRemainderContext(params []interface{}) interface{} {
	...
	mc := params[2].(*object.Object)
	if object.IsNull(mc) {
		return ghelpers.GetGErrBlk(excNames.NullPointerException, "bigdecimalDivideAndRemainder: MathContext is null")
	}
...
func bigdecimalDivideToIntegralValueContext(params []interface{}) interface{} {
	...
	mc := params[2].(*object.Object)
	if object.IsNull(mc) {
		return ghelpers.GetGErrBlk(excNames.NullPointerException, "bigdecimalDivideToIntegralValue: MathContext is null")
	}
...
func bigdecimalMultiplyContext(params []interface{}) interface{} {
	...
	mc := params[2].(*object.Object)
	if object.IsNull(mc) {
		return ghelpers.GetGErrBlk(excNames.NullPointerException, "bigdecimalMultiply: MathContext is null")
	}
