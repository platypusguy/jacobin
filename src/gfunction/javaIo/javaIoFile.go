...
func Load_Io_File() {
	ghelpers.MethodSignatures["java/io/File.<clinit>()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
	...
	// Constructors
	ghelpers.MethodSignatures["java/io/File.<init>(Ljava/io/File;Ljava/lang/String;)V"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  fileInit,
		}
	ghelpers.MethodSignatures["java/io/File.<init>(Ljava/lang/String;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  fileInit,
		}
	ghelpers.MethodSignatures["java/io/File.<init>(Ljava/lang/String;Ljava/lang/String;)V"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  fileInit,
		}
	ghelpers.MethodSignatures["java/io/File.<init>(Ljava/net/URI;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  fileInit,
		}
	...
	ghelpers.MethodSignatures["java/io/File.canExecute()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileCanExecute,
		}
	ghelpers.MethodSignatures["java/io/File.canRead()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileCanRead,
		}
	ghelpers.MethodSignatures["java/io/File.canWrite()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileCanWrite,
		}
	ghelpers.MethodSignatures["java/io/File.compareTo(Ljava/io/File;)I"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  fileCompareTo,
		}
	ghelpers.MethodSignatures["java/io/File.createNewFile()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileCreate,
		}
	ghelpers.MethodSignatures["java/io/File.createTempFile(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  fileCreateTemp,
		}
	ghelpers.MethodSignatures["java/io/File.delete()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileDelete,
		}
	ghelpers.MethodSignatures["java/io/File.deleteOnExit()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}
	ghelpers.MethodSignatures["java/io/File.equals(Ljava/lang/Object;)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  fileEquals,
		}
	ghelpers.MethodSignatures["java/io/File.exists()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileExists,
		}
	ghelpers.MethodSignatures["java/io/File.getAbsoluteFile()Ljava/io/File;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}
	ghelpers.MethodSignatures["java/io/File.getAbsolutePath()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileGetAbsolutePath,
		}
	ghelpers.MethodSignatures["java/io/File.getCanonicalFile()Ljava/io/File;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}
	ghelpers.MethodSignatures["java/io/File.getCanonicalPath()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileGetCanonicalPath,
		}
	ghelpers.MethodSignatures["java/io/File.getName()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileGetName,
		}
	ghelpers.MethodSignatures["java/io/File.getParent()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileGetParent,
		}
	ghelpers.MethodSignatures["java/io/File.getParentFile()Ljava/io/File;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileGetParentFile,
		}
	ghelpers.MethodSignatures["java/io/File.getPath()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileGetPath,
		}
	ghelpers.MethodSignatures["java/io/File.getTotalSpace()J"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}
	ghelpers.MethodSignatures["java/io/File.getUsableSpace()J"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}
	ghelpers.MethodSignatures["java/io/File.getFreeSpace()J"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileGetFreeSpace,
		}
	ghelpers.MethodSignatures["java/io/File.hashCode()I"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileHashCode,
		}
	ghelpers.MethodSignatures["java/io/File.isAbsolute()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileIsAbsolute,
		}
	ghelpers.MethodSignatures["java/io/File.isInvalid()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileIsInvalid,
		}
	ghelpers.MethodSignatures["java/io/File.isDirectory()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileIsDirectory,
		}
	ghelpers.MethodSignatures["java/io/File.isFile()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileIsFile,
		}
	ghelpers.MethodSignatures["java/io/File.isHidden()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileIsHidden,
		}
	ghelpers.MethodSignatures["java/io/File.lastModified()J"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileLastModified,
		}
	ghelpers.MethodSignatures["java/io/File.length()J"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileLength,
		}
	ghelpers.MethodSignatures["java/io/File.list()[Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileList,
		}
	ghelpers.MethodSignatures["java/io/File.list(Ljava/io/FilenameFilter;)[Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  fileListFiltered,
		}
	ghelpers.MethodSignatures["java/io/File.listFiles()[Ljava/io/File;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileListFiles,
		}
	ghelpers.MethodSignatures["java/io/File.listFiles(Ljava/io/FileFilter;)[Ljava/io/File;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  fileListFilesWithFileFilter,
		}
	ghelpers.MethodSignatures["java/io/File.listFiles(Ljava/io/FilenameFilter;)[Ljava/io/File;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  fileListFilesWithFilenameFilter,
		}
	ghelpers.MethodSignatures["java/io/File.mkdir()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileMkdir,
		}
	ghelpers.MethodSignatures["java/io/File.mkdirs()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileMkdirs,
		}
	ghelpers.MethodSignatures["java/io/File.renameTo(Ljava/io/File;)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  fileRenameTo,
		}
	ghelpers.MethodSignatures["java/io/File.setExecutable(Z)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  fileSetExecutable,
		}
	ghelpers.MethodSignatures["java/io/File.setExecutable(ZZ)Z"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  fileSetExecutable2,
		}
	ghelpers.MethodSignatures["java/io/File.setLastModified(J)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}
	ghelpers.MethodSignatures["java/io/File.setReadable(Z)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  fileSetReadable,
		}
	ghelpers.MethodSignatures["java/io/File.setReadable(ZZ)Z"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  fileSetReadable2,
		}
	ghelpers.MethodSignatures["java/io/File.setReadOnly()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  fileSetReadOnly,
		}
	ghelpers.MethodSignatures["java/io/File.setWritable(Z)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  fileSetWritable,
		}
	ghelpers.MethodSignatures["java/io/File.setWritable(ZZ)Z"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  fileSetWritable2,
		}
	ghelpers.MethodSignatures["java/io/File.toURI()Ljava/net/URI;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/io/File.toURL()Ljava/net/URL;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapDeprecated,
		}

	ghelpers.MethodSignatures["java/io/File.toPath()Ljava/nio/file/Path;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}
	ghelpers.MethodSignatures["java/io/File.toString()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
	...
	// Static Methods
	ghelpers.MethodSignatures["java/io/File.createTempFile(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;)Ljava/io/File;"] =
		ghelpers.GMeth{
			ParamSlots: 3,
			GFunction:  fileCreateTempWithDir,
		}
	ghelpers.MethodSignatures["java/io/File.listRoots()[Ljava/io/File;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
...
func fileInit(params []interface{}) interface{} {
	...
	objFile.FieldTable[ghelpers.FileStatus] = fld
...
func fileGetPath(params []interface{}) interface{} {
	fld, ok := params[0].(*object.Object).FieldTable[ghelpers.FilePath]
	if !ok {
		errMsg := "fileGetPath: File object lacks a ghelpers.FilePath field"
		return ghelpers.GetGErrBlk(excNames.IOException, errMsg)
	}
...
func fileIsInvalid(params []interface{}) interface{} {
	status, ok := params[0].(*object.Object).FieldTable[ghelpers.FileStatus].Fvalue.(int64)
	if !ok {
		errMsg := "fileIsInvalid: File object lacks a ghelpers.FileStatus field"
		return ghelpers.GetGErrBlk(excNames.IOException, errMsg)
	}
	if status == 0 {
		return int64(1)
...
func fileDelete(params []interface{}) interface{} {
	...
	fld, ok := params[0].(*object.Object).FieldTable[ghelpers.FilePath]
	if !ok {
		errMsg := "fileDelete: File object lacks a ghelpers.FilePath field"
		return ghelpers.GetGErrBlk(excNames.IOException, errMsg)
	}
...
func fileCreate(params []interface{}) interface{} {
	...
	fld, ok := params[0].(*object.Object).FieldTable[ghelpers.FilePath]
	if !ok {
		errMsg := "fileCreate: File object lacks a ghelpers.FilePath field"
		return ghelpers.GetGErrBlk(excNames.IOException, errMsg)
	}
	pathStr := object.GoStringFromJavaByteArray(fld.Fvalue.([]types.JavaByte))
...
// --- Helpers ---
func fileGetPathString(obj *object.Object) (string, *ghelpers.GErrBlk) {
	fld, ok := obj.FieldTable[ghelpers.FilePath]
	if !ok {
		return "", ghelpers.GetGErrBlk(excNames.IOException, "File object lacks a ghelpers.FilePath field")
	}
	jb, ok := fld.Fvalue.([]types.JavaByte)
	if !ok {
		return "", ghelpers.GetGErrBlk(excNames.IOException, "ghelpers.FilePath field has invalid type")
	}
