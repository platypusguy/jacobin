...
func linkedlistAddFirst(params []interface{}) interface{} {
	...
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "linkedlistAddFirst: Invalid self argument")
	}
	element := params[1]
...
func linkedlistAddLast(params []interface{}) interface{} {
	self, ok := params[0].(*object.Object)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "linkedlistAddLast: Invalid self argument")
	}
	element := params[1]

	llst, gerr := getLinkedListFromObject(self)
	if gerr != nil {
		return gerr
	}
...
func linkedlistAddLastRetBool(params []interface{}) interface{} {
	...
	self, ok := params[0].(*object.Object)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "linkedlistAddLastRetBool: Invalid self argument")
	}
	element := params[1]
...
func linkedlistClear(params []interface{}) interface{} {
	self, ok := params[0].(*object.Object)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "linkedlistClear: Invalid self argument")
	}
	llst, err := getLinkedListFromObject(self)
	if err != nil {
		return err
...
func linkedlistClone(params []interface{}) interface{} {
...
func linkedlistContains(params []interface{}) interface{} {
	self, ok := params[0].(*object.Object)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "linkedlistContains: Invalid self argument")
	}
	element := params[1]
...
func linkedlistGet(params []interface{}) interface{} {
	self, ok := params[0].(*object.Object)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "linkedlistGet: Invalid self argument")
	}

	idx, ok := params[1].(int64)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "linkedlistGet: Invalid index argument")
	}
...
func linkedlistGetFirst(params []interface{}) interface{} {
	self, ok := params[0].(*object.Object)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "linkedlistGetFirst: Invalid self argument")
	}
	...
	if llst.Len() == 0 {
		return getGErrBlk(excNames.NoSuchElementException, "linkedlistGetFirst: LinkedList is empty")
	}
...
func linkedlistGetLast(params []interface{}) interface{} {
	self, ok := params[0].(*object.Object)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "linkedlistGetLast: Invalid self argument")
	}
	...
	if llst.Len() == 0 {
		return getGErrBlk(excNames.NoSuchElementException, "linkedlistGetLast: LinkedList is empty")
	}
...
func linkedlistIsEmpty(params []interface{}) interface{} {
	self, ok := params[0].(*object.Object)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "linkedlistIsEmpty: Invalid self argument")
	}
	llst, err := getLinkedListFromObject(self)
	if err != nil {
		return err
