...
func Load_Util_Base64() {
	...
	MethodSignatures["java/util/Base64.<clinit>()V"] =
		GMeth{
			ParamSlots: 0,
			GFunction:  clinitGeneric,
		}

	MethodSignatures["java/util/Base64$Decoder.<clinit>()V"] =
		GMeth{
			ParamSlots: 0,
			GFunction:  clinitGeneric,
		}

	MethodSignatures["java/util/Base64$Encoder.<clinit>()V"] =
		GMeth{
			ParamSlots: 0,
			GFunction:  clinitGeneric,
		}

	MethodSignatures["java/util/Base64.getDecoder()Ljava/util/Base64$Decoder;"] =
		GMeth{
			ParamSlots: 0,
			GFunction:  base64GetStdDecoder,
		}

	MethodSignatures["java/util/Base64.getEncoder()Ljava/util/Base64$Encoder;"] =
		GMeth{
			ParamSlots: 0,
			GFunction:  base64GetStdEncoder,
		}

	MethodSignatures["java/util/Base64.getMimeDecoder()Ljava/util/Base64$Decoder;"] =
		GMeth{
			ParamSlots: 0,
			GFunction:  base64GetMimeDecoder,
		}

	MethodSignatures["java/util/Base64.getMimeEncoder()Ljava/util/Base64$Encoder;"] =
		GMeth{
			ParamSlots: 0,
			GFunction:  base64GetMimeEncoder,
		}

	MethodSignatures["java/util/Base64.getMimeEncoder(I[B)Ljava/util/Base64$Encoder;"] =
		GMeth{
			ParamSlots: 2,
			GFunction:  trapFunction,
		}

	MethodSignatures["java/util/Base64.getUrlDecoder()Ljava/util/Base64$Decoder;"] =
		GMeth{
			ParamSlots: 0,
			GFunction:  base64GetUrlDecoder,
		}

	MethodSignatures["java/util/Base64.getUrlEncoder()Ljava/util/Base64$Encoder;"] =
		GMeth{
			ParamSlots: 0,
			GFunction:  base64GetUrlEncoder,
		}

	MethodSignatures["java/util/Base64$Encoder.encode([B)[B"] =
		GMeth{
			ParamSlots: 1,
			GFunction:  base64EncodeBsrc,
		}

	MethodSignatures["java/util/Base64$Encoder.encode([B[B)I"] =
		GMeth{
			ParamSlots: 2,
			GFunction:  base64EncodeBsrcBdst,
		}

	MethodSignatures["java/util/Base64$Encoder.encode(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;"] =
		GMeth{
			ParamSlots: 1,
			GFunction:  trapFunction,
		}

	MethodSignatures["java/util/Base64$Encoder.encodeToString([B)Ljava/lang/String;"] =
		GMeth{
			ParamSlots: 1,
			GFunction:  base64EncodeBsrcToString,
		}

	MethodSignatures["java/util/Base64$Encoder.withoutPadding()Ljava/util/Base64$Encoder;"] =
		GMeth{
			ParamSlots: 0,
			GFunction:  base64WithoutPadding,
		}

	MethodSignatures["java/util/Base64$Encoder.wrap(Ljava/io/OutputStream;)Ljava/io/OutputStream;"] =
		GMeth{
			ParamSlots: 1,
			GFunction:  trapFunction,
		}

	MethodSignatures["java/util/Base64$Decoder.decode([B)[B"] =
		GMeth{
			ParamSlots: 1,
			GFunction:  base64Decode,
		}

	MethodSignatures["java/util/Base64$Decoder.decode([B[B)I"] =
		GMeth{
			ParamSlots: 2,
			GFunction:  base64DecodeBsrcBdst,
		}

	MethodSignatures["java/util/Base64$Decoder.decode(Ljava/lang/String;)[B"] =
		GMeth{
			ParamSlots: 1,
			GFunction:  base64Decode,
		}

	MethodSignatures["java/util/Base64$Decoder.decode(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;"] =
		GMeth{
			ParamSlots: 1,
			GFunction:  trapFunction,
		}

	MethodSignatures["java/util/Base64$Decoder.wrap(Ljava/io/InputStream;)Ljava/io/InputStream;"] =
		GMeth{
			ParamSlots: 1,
			GFunction:  trapFunction,
		}
...
func base64WithoutPadding(params []interface{}) interface{} {
	...
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "base64WithoutPadding: base-object parameter is not an object")
	}
...
func _encodeBase64(params []interface{}) (interface{}, bool) {
	if len(params) < 2 {
		return getGErrBlk(excNames.IllegalArgumentException, "_encodeBase64: expects at least 2 parameters"), false
	}

	// this: Base64 encoder object.
	this, ok := params[0].(*object.Object)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "_encodeBase64: base-object parameter is not an object"), false
	}
	...
	if !ok {
		...
		return getGErrBlk(excNames.VirtualMachineError, errMsg), false
	}
	scheme, ok := schemeField.Fvalue.(int64)
	if !ok {
	...
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "_encodeBase64: source parameter is not an object"), false
	}
...
func _decodeBase64(params []interface{}) (interface{}, bool) {
	if len(params) < 2 {
		return getGErrBlk(excNames.IllegalArgumentException, "_decodeBase64: expects at least 2 parameters"), false
	}

	// this: Base64 encoder object.
	this, ok := params[0].(*object.Object)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "_decodeBase64: base-object parameter is not an object"), false
	}
	...
	srcObject, ok := params[1].(*object.Object)
	if !ok {
		return getGErrBlk(excNames.IllegalArgumentException, "_decodeBase64: source parameter is not an object"), false
	}
	srcJB, ok := srcObject.FieldTable[fieldNameValue].Fvalue.([]types.JavaByte)
	if !ok {
