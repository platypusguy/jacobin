...
func Load_Math_SimpleDateFormat() {
	...
	ghelpers.MethodSignatures["java/text/SimpleDateFormat.<init>()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  sdfInit,
		}

	ghelpers.MethodSignatures["java/text/SimpleDateFormat.<init>(Ljava/lang/String;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  sdfInitString,
		}

	ghelpers.MethodSignatures["java/text/SimpleDateFormat.<init>(Ljava/lang/String;Ljava/text/DateFormatSymbols;)V"] =
		ghelpers.GMeth{
			ParamSlots: 2,
	...
	ghelpers.MethodSignatures["java/text/SimpleDateFormat.applyPattern(Ljava/lang/String;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  sdfApplyPattern,
		}

	ghelpers.MethodSignatures["java/text/SimpleDateFormat.clone()Ljava/lang/Object;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  sdfClone,
		}
	...
	ghelpers.MethodSignatures["java/text/SimpleDateFormat.format(Ljava/util/Date;Ljava/lang/StringBuffer;Ljava/text/FieldPosition;)Ljava/lang/StringBuffer;"] =
		ghelpers.GMeth{
			ParamSlots: 3,
			GFunction:  ghelpers.TrapFunction,
		}
	...
	ghelpers.MethodSignatures["java/text/SimpleDateFormat.toLocalizedPattern()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  sdfToPattern,
		}

	ghelpers.MethodSignatures["java/text/SimpleDateFormat.toPattern()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  sdfToPattern,
		}
...
func sdfFormat(params []interface{}) interface{} {
	if len(params) < 2 {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "sdfFormat: missing parameters")
	}
	obj, ok := params[0].(*object.Object)
	if !ok || obj == nil {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "sdfFormat: self is not an object")
	}
	dateObj, ok := params[1].(*object.Object)
	if !ok || dateObj == nil {
		return ghelpers.GetGErrBlk(excNames.NullPointerException, "sdfFormat: date parameter is null")
	}
...
func sdfParse(params []interface{}) interface{} {
	if len(params) < 2 {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "sdfParse: missing parameters")
	}
	obj, ok := params[0].(*object.Object)
	if !ok || obj == nil {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "sdfParse: self is not an object")
	}
	strObj, ok := params[1].(*object.Object)
	if !ok || strObj == nil {
		return ghelpers.GetGErrBlk(excNames.NullPointerException, "sdfParse: string parameter is null")
	}
	...
	if err != nil {
		return ghelpers.GetGErrBlk(excNames.ParseException, fmt.Sprintf("sdfParse: failed to parse %q with layout %q: %v", inputStr, goLayout, err))
	}
