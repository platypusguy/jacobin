...
func MTableLoadGFunctions(MTable *classloader.MT) {
	...
	javaLang.Load_Lang_Classloader()
	...
	javaLang.Load_Lang_Invoke_StringConcatFactory()
	...
	javaSecurity.Load_Security_SecretKey()
	...
	javaUtil.Load_Util_Function_Supplier()
	...
	javaUtil.Load_Util_Logging_ConsoleHandler()
	javaUtil.Load_Util_Logging_FileHandler()
	javaUtil.Load_Util_Logging_Filter()
	javaUtil.Load_Util_Logging_Formatter()
	javaUtil.Load_Util_Logging_Handler()
	javaUtil.Load_Util_Logging_Level()
	javaUtil.Load_Util_Logging_Logger()
	javaUtil.Load_Util_Logging_LogManager()
	javaUtil.Load_Util_Logging_LogRecord()
	javaUtil.Load_Util_Logging_MemoryHandler()
	javaUtil.Load_Util_Logging_SimpleFormatter()
	javaUtil.Load_Util_Logging_SocketHandler()
	javaUtil.Load_Util_Logging_StreamHandler()
	...
	javaUtil.Load_Util_ResourceBundle()
