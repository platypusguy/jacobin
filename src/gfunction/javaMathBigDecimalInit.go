...
func bigdecimalInitDoubleContext(params []interface{}) interface{} {
	...
	if object.IsNull(mc) {
		return getGErrBlk(excNames.NullPointerException, "BigDecimal.<init>(double, MathContext): MathContext is null")
	}
...
func bigdecimalInitStringContext(params []interface{}) interface{} {
	...
	mc := params[2].(*object.Object)
	if object.IsNull(mc) {
		return getGErrBlk(excNames.NullPointerException, "BigDecimal.<init>(String, MathContext): MathContext is null")
	}
...
func bigdecimalInitBigIntegerContext(params []interface{}) interface{} {
	...
	mc := params[2].(*object.Object)
	if object.IsNull(mc) {
		return getGErrBlk(excNames.NullPointerException, "BigDecimal.<init>(BigInteger, MathContext): MathContext is null")
	}
