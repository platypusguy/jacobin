...
func TestFloat_Coverage(t *testing.T) {
	...
	if blk, ok := floatCompare([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatCompare(1) expected IllegalArgumentException")
	}
	if blk, ok := floatCompare([]interface{}{1.0, "abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
	...
	if blk, ok := floatCompareTo([]interface{}{f1}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatCompareTo(1) expected IllegalArgumentException")
	}
	if blk, ok := floatCompareTo([]interface{}{1.0, 2.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatCompareTo(float, float) expected IllegalArgumentException")
	}

	// floatFloatToIntBits error paths
	if blk, ok := floatFloatToIntBits([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatFloatToIntBits() expected IllegalArgumentException")
	}
	if blk, ok := floatFloatToIntBits([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
	...
	if blk, ok := floatFloatToRawIntBits([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatFloatToRawIntBits() expected IllegalArgumentException")
	}
	if blk, ok := floatFloatToRawIntBits([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatFloatToRawIntBits(string) expected IllegalArgumentException")
	}

	// floatEquals error paths
	if blk, ok := floatEquals([]interface{}{f1}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatEquals(1) expected IllegalArgumentException")
	}
	if blk, ok := floatEquals([]interface{}{1.0, f2}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
	...
	if blk, ok := floatIntBitsToFloat([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatIntBitsToFloat() expected IllegalArgumentException")
	}
	if blk, ok := floatIntBitsToFloat([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatIntBitsToFloat(string) expected IllegalArgumentException")
	}

	// floatMax / floatMin / floatSum error paths
	if blk, ok := floatMax([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatMax(1) expected IllegalArgumentException")
	}
	if blk, ok := floatMax([]interface{}{1.0, "abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
	...
	if blk, ok := floatMin([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatMin(1) expected IllegalArgumentException")
	}
	if blk, ok := floatMin([]interface{}{1.0, "abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
	...
	if blk, ok := floatSum([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatSum(1) expected IllegalArgumentException")
	}
	if blk, ok := floatSum([]interface{}{1.0, "abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatSum(1, string) expected IllegalArgumentException")
	}

	// floatParseFloat error paths
	if blk, ok := floatParseFloat([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatParseFloat() expected IllegalArgumentException")
	}
	if blk, ok := floatParseFloat([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatParseFloat(float) expected IllegalArgumentException")
	}
	sEmpty := object.StringObjectFromGoString("")
	if blk, ok := floatParseFloat([]interface{}{sEmpty}).(*GErrBlk); !ok || blk.ExceptionType != excNames.NullPointerException {
		t.Errorf("floatParseFloat(empty) expected NullPointerException")
	}

	// floatToHexString error paths
	if blk, ok := floatToHexString([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatToHexString() expected IllegalArgumentException")
	}
	if blk, ok := floatToHexString([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
	...
	// error paths
	if blk, ok := floatToStringStatic([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatToStringStatic() expected IllegalArgumentException")
	}
	if blk, ok := floatToStringStatic([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatToStringStatic(string) expected IllegalArgumentException")
	}

	// floatValueOf error paths
	if blk, ok := floatValueOf([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatValueOf() expected IllegalArgumentException")
	}
	if blk, ok := floatValueOf([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatValueOf(string) expected IllegalArgumentException")
	}

	// floatValueOfString error paths
	if blk, ok := floatValueOfString([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatValueOfString() expected IllegalArgumentException")
	}
	if blk, ok := floatValueOfString([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatValueOfString(float) expected IllegalArgumentException")
	}
	sInv := object.StringObjectFromGoString("abc")
	if blk, ok := floatValueOfString([]interface{}{sInv}).(*GErrBlk); !ok || blk.ExceptionType != excNames.NumberFormatException {
		t.Errorf("floatValueOfString(abc) expected NumberFormatException")
	}

	// floatFloat16ToFloat / floatFloatToFloat16 error paths
	if blk, ok := floatFloat16ToFloat([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatFloat16ToFloat() expected IllegalArgumentException")
	}
	if blk, ok := floatFloat16ToFloat([]interface{}{1.0}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatFloat16ToFloat(float) expected IllegalArgumentException")
	}
	if blk, ok := floatFloatToFloat16([]interface{}{}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
		t.Errorf("floatFloatToFloat16() expected IllegalArgumentException")
	}
	if blk, ok := floatFloatToFloat16([]interface{}{"abc"}).(*GErrBlk); !ok || blk.ExceptionType != excNames.IllegalArgumentException {
