...
func TestLoadSecurityProviderService(t *testing.T) {
	...
	// Verify constructor
	if _, exists := MethodSignatures["java/security/Provider$Service.<init>(Ljava/security/Provider;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)V"]; !exists {
...
func TestSecurityProvSvcInitNullProvider(t *testing.T) {
	...
	if !ok {
		t.Fatalf("Expected *GErrBlk for null provider, got %T", result)
	}
...
func TestSecurityProvSvcInitNullType(t *testing.T) {
	...
	gerr, ok := result.(*GErrBlk)
	if !ok {
		t.Fatalf("Expected *GErrBlk for null type, got %T", result)
	}
	if gerr.ExceptionType != excNames.NullPointerException {
		t.Errorf("Expected NullPointerException, got %v", gerr.ExceptionType)
	}
...
func TestSecurityProvSvcInitNullAlgorithm(t *testing.T) {
	...
	gerr, ok := result.(*GErrBlk)
	if !ok {
		t.Fatalf("Expected *GErrBlk for null algorithm, got %T", result)
	}
	if gerr.ExceptionType != excNames.NullPointerException {
		t.Errorf("Expected NullPointerException, got %v", gerr.ExceptionType)
	}
...
func TestSecurityProvSvcInitNullClassName(t *testing.T) {
	...
	gerr, ok := result.(*GErrBlk)
	if !ok {
		t.Fatalf("Expected *GErrBlk for null className, got %T", result)
	}
	if gerr.ExceptionType != excNames.NullPointerException {
		t.Errorf("Expected NullPointerException, got %v", gerr.ExceptionType)
	}
