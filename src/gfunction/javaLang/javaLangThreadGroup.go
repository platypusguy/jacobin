...
func Load_Lang_Thread_Group() {
	...
	// <clinit>
	ghelpers.MethodSignatures["java/lang/ThreadGroup.<clinit>()V"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: threadGroupClinit}

	// Constructors
	ghelpers.MethodSignatures["java/lang/ThreadGroup.<init>(Ljava/lang/String;)V"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: threadGroupInitWithName}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.<init>(Ljava/lang/ThreadGroup;Ljava/lang/String;)V"] =
		ghelpers.GMeth{ParamSlots: 2, GFunction: threadGroupInitWithParentAndName}

	// Public instance methods (alphabetical by JVM signature for consistency)
	ghelpers.MethodSignatures["java/lang/ThreadGroup.activeCount()I"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: threadGroupActiveCount}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.activeGroupCount()I"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.allowThreadSuspension(Z)Z"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.checkAccess()V"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.destroy()V"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.enumerate([Ljava/lang/Thread;)I"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.enumerate([Ljava/lang/Thread;Z)I"] =
		ghelpers.GMeth{ParamSlots: 2, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.enumerate([Ljava/lang/ThreadGroup;)I"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.enumerate([Ljava/lang/ThreadGroup;Z)I"] =
		ghelpers.GMeth{ParamSlots: 2, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.getMaxPriority()I"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: threadGroupGetMaxPriority}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.getName()Ljava/lang/String;"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: threadGroupGetName}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.getParent()Ljava/lang/ThreadGroup;"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: threadGroupGetParent}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.interrupt()V"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.isDaemon()Z"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.isDestroyed()Z"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.list()V"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.parentOf(Ljava/lang/ThreadGroup;)Z"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.setDaemon(Z)V"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.setMaxPriority(I)V"] =
		ghelpers.GMeth{ParamSlots: 1, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.stop()V"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.suspend()V"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.resume()V"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.toString()Ljava/lang/String;"] =
		ghelpers.GMeth{ParamSlots: 0, GFunction: ghelpers.TrapFunction}
	ghelpers.MethodSignatures["java/lang/ThreadGroup.uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V"] =
		ghelpers.GMeth{ParamSlots: 2, GFunction: ghelpers.TrapFunction}
}

// java/lang/ThreadGroup.<clinit>()V
func threadGroupClinit(_ []interface{}) any {
	return ghelpers.JustReturn(nil)
}
