...
func TestStringCharAt(t *testing.T) {
	...
	if gErr, ok := resObj.(*ghelpers.GErrBlk); !ok || gErr.ExceptionType != excNames.StringIndexOutOfBoundsException {
	...
	resObj = stringCharAt(params)
	if gErr, ok := resObj.(*ghelpers.GErrBlk); !ok || gErr.ExceptionType != excNames.NullPointerException {
...
func TestStringCompareToCaseSensitive(t *testing.T) {
	...
	if gErr, ok := resGeneric.(*ghelpers.GErrBlk); !ok || gErr.ExceptionType != excNames.NullPointerException {
...
func TestStringConcat(t *testing.T) {
	...
	if gErr, ok := res2.(*ghelpers.GErrBlk); !ok || gErr.ExceptionType != excNames.NullPointerException {
...
func TestSubstringStartEnd(t *testing.T) {
	...
	if gErr, ok := res2.(*ghelpers.GErrBlk); !ok || gErr.ExceptionType != excNames.StringIndexOutOfBoundsException {
...
func TestSubstringToTheEnd_Boundary(t *testing.T) {
	...
	if gErr, ok := resGeneric.(*ghelpers.GErrBlk); !ok || gErr.ExceptionType != excNames.StringIndexOutOfBoundsException {
...
func TestStringGetChars(t *testing.T) {
	...
	params = []interface{}{strObj, int64(-1), int64(4), charArrayObj, int64(2)}
	res = stringGetChars(params)
	if gErr, ok := res.(*ghelpers.GErrBlk); !ok || gErr.ExceptionType != excNames.StringIndexOutOfBoundsException {
	...
	res = stringGetChars(params)
	if gErr, ok := res.(*ghelpers.GErrBlk); !ok || gErr.ExceptionType != excNames.ArrayIndexOutOfBoundsException {
