...
func TestByteDecode_Various(t *testing.T) {
	...
	if blk, ok := byteDecode([]interface{}{s}).(*ghelpers.GErrBlk); !ok || blk.ExceptionType != excNames.NumberFormatException {
...
func TestByte_CoverageExt(t *testing.T) {
	...
	if blk, ok := byteDecode([]interface{}{sEmpty}).(*ghelpers.GErrBlk); !ok || blk.ExceptionType != excNames.NumberFormatException {
	...
	if blk, ok := byteDecode([]interface{}{sOutOfRange}).(*ghelpers.GErrBlk); !ok || blk.ExceptionType != excNames.NumberFormatException {
	...
	if blk, ok := byteParseByte([]interface{}{sInvalid}).(*ghelpers.GErrBlk); !ok || blk.ExceptionType != excNames.NumberFormatException {
		t.Errorf("byteParseByte('abc') expected NFE, got %T", blk)
	}

	// byteParseByteRadix error & invalid radix
	if blk, ok := byteParseByteRadix([]interface{}{sInvalid, int64(16)}).(*ghelpers.GErrBlk); !ok || blk.ExceptionType != excNames.NumberFormatException {
		t.Errorf("byteParseByteRadix('abc', 16) expected NFE, got %T", blk)
	}
	if blk, ok := byteParseByteRadix([]interface{}{sInvalid, int64(1)}).(*ghelpers.GErrBlk); !ok || blk.ExceptionType != excNames.NumberFormatException {
	...
	if blk, ok := byteValueOfString([]interface{}{sInvalid, int64(10)}).(*ghelpers.GErrBlk); !ok || blk.ExceptionType != excNames.NumberFormatException {
