...
func Load_Lang_Process_Handle_Impl() {
	...
	ghelpers.MethodSignatures["java/lang/ProcessHandle.<clinit>()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  processHandleImplClinit,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.allProcesses()Ljava/util/Stream;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.children()Ljava/util/Stream;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.compareTo(Ljava/lang/ProcessHandle;)I"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.current()Ljava/lang/ProcessHandle;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  processHandleImplCurrent,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.descendents()Ljava/util/Stream;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.destroy()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction, // O/S dependent
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.destroyForcibly()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction, // O/S dependent
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.equals(Ljava/lang/Object;)Z"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  processHandleImplEquals,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.getCurrentPid()J"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  processHandleImplCurrentPid,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.getCurrentPid0()J"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  processHandleImplCurrentPid,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.hashCode()I"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.info()Ljava/lang/ProcessHandle$Info;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  processHandleImplInfo,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.initNative()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.JustReturn,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.isAlive()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  processHandleImplIsAlive,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.isAlive0(J)J"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  processHandleImplIsAlive0,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.of(J)Ljava/util/Optional;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.onExit()Ljava/util.concurrent/CompletableFuture;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.parent()Ljava/util/Optional;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.pid()J"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  processHandleImplCurrentPid,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle.supportsNormalTermination()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle$Info.arguments()Ljava/util/Optional;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  processHandleInfoArguments,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle$Info.command()Ljava/util/Optional;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  processHandleInfoCommand,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle$Info.commandLine()Ljava/util/Optional;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  processHandleInfoCommandLine,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle$Info.startInstant()Ljava/util/Optional;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle$Info.totalCpuDuration()Ljava/util/Optional;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/ProcessHandle$Info.user()Ljava/util/Optional;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
...
func processHandleImplClinit([]interface{}) interface{} {
...
func processHandleInfoArguments(params []interface{}) interface{} {
	...
	outObj := object.MakePrimitiveObject(types.ClassNameOptional, types.RefArray, strObjArray)
	return outObj
}
...
func processHandleInfoCommand(params []interface{}) interface{} {
	...
	outObj := object.MakePrimitiveObject(types.ClassNameOptional, types.StringClassName, strObj)
	return outObj
}
