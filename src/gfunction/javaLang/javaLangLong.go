...
func Load_Lang_Long() {
	...
	ghelpers.MethodSignatures["java/lang/Long.compareUnsigned(JJ)I"] =
		ghelpers.GMeth{
			ParamSlots: 2,
	...
	ghelpers.MethodSignatures["java/lang/Long.doubleValue()D"] =
		ghelpers.GMeth{
			ParamSlots: 0,
	...
	ghelpers.MethodSignatures["java/lang/Long.min(JJ)J"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  longMin,
		}

	ghelpers.MethodSignatures["java/lang/Long.numberOfLeadingZeros(J)I"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  longNumberOfLeadingZeros,
		}

	ghelpers.MethodSignatures["java/lang/Long.numberOfTrailingZeros(J)I"] =
		ghelpers.GMeth{
			ParamSlots: 1,
	...
	ghelpers.MethodSignatures["java/lang/Long.reverseBytes(J)J"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  longReverseBytes,
		}

	ghelpers.MethodSignatures["java/lang/Long.rotateLeft(JI)J"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  longRotateLeft,
		}

	ghelpers.MethodSignatures["java/lang/Long.rotateRight(JI)J"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  longRotateRight,
		}

	ghelpers.MethodSignatures["java/lang/Long.signum(J)I"] =
		ghelpers.GMeth{
			ParamSlots: 1,
	...
	ghelpers.MethodSignatures["java/lang/Long.toBinaryString(J)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  longToBinaryString,
		}

	ghelpers.MethodSignatures["java/lang/Long.toHexString(J)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  longToHexString,
		}

	ghelpers.MethodSignatures["java/lang/Long.toOctalString(J)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  longToOctalString,
		}

	ghelpers.MethodSignatures["java/lang/Long.toString(J)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
	...
	ghelpers.MethodSignatures["java/lang/Long.toUnsignedString(JI)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 2,
...
func longBitCount(params []interface{}) interface{} {
	...
	if !ok {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "longBitCount: Invalid argument type")
	}
...
func longCompare(params []interface{}) interface{} {
	...
	if !ok1 || !ok2 {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "longCompare: Invalid argument types")
	}
	if inputA < inputB {
		return int64(-1)
...
func longCompareUnsigned(params []interface{}) interface{} {
	...
	if !ok1 || !ok2 {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "longCompareUnsigned: Invalid argument types")
	}
...
func longDivideUnsigned(params []interface{}) interface{} {
	...
	if !ok1 || !ok2 {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "longDivideUnsigned: Invalid argument types")
	}
	if divisor == 0 {
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "longDivideUnsigned: Division by zero")
	}
...
func longRemainderUnsigned(params []interface{}) interface{} {
	...
	divisor, ok2 := params[1].(int64)
	if !ok1 || !ok2 {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "longRemainderUnsigned: Invalid argument types")
	}
	if divisor == 0 {
		return ghelpers.GetGErrBlk(excNames.ArithmeticException, "longRemainderUnsigned: Division by zero")
	}
	return int64(uint64(dividend) % uint64(divisor))
}
...
func longHighestOneBit(params []interface{}) interface{} {
	input, ok := params[0].(int64)
	if !ok {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "longHighestOneBit: Invalid argument type")
	}
	if input == 0 {
		return int64(0)
	}
...
func longLowestOneBit(params []interface{}) interface{} {
	input, ok := params[0].(int64)
	if !ok {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "longLowestOneBit: Invalid argument type")
	}
	return input & -input
}
...
func longReverse(params []interface{}) interface{} {
	i, ok := params[0].(int64)
	if !ok {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "longReverse: Invalid argument type")
	}
...
func longReverseBytes(params []interface{}) interface{} {
	i, ok := params[0].(int64)
	if !ok {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "longReverseBytes: Invalid argument type")
	}
...
func longCompress(params []interface{}) interface{} {
	...
	if !ok1 || !ok2 {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "longCompress: Invalid argument types")
	}
...
func longExpand(params []interface{}) interface{} {
	...
	maskRaw, ok2 := params[1].(int64)
	if !ok1 || !ok2 {
		return ghelpers.GetGErrBlk(excNames.IllegalArgumentException, "longExpand: Invalid argument types")
	}
