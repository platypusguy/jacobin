...
/*
 Each object or library that has golang methods contains a reference to ghelpers.MethodSignatures,
...
func Load_Lang_System() {
	...
	ghelpers.MethodSignatures["java/lang/System.<clinit>()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.ClinitGeneric,
		}

	ghelpers.MethodSignatures["java/lang/System.allowSecurityManager()Z"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.ReturnFalse,
		}

	ghelpers.MethodSignatures["java/lang/System.arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V"] = // copy array (full or partial)
		ghelpers.GMeth{
			ParamSlots: 5,
			GFunction:  systemArrayCopy,
		}

	ghelpers.MethodSignatures["java/lang/System.clearProperty(Ljava/lang/String;)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  systemClearProperty,
		}

	ghelpers.MethodSignatures["java/lang/System.console()Ljava/io/Console;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  systemConsole,
		}

	ghelpers.MethodSignatures["java/lang/System.currentTimeMillis()J"] = // get time in ms since Jan 1, 1970, returned as long
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  systemCurrentTimeMillis,
		}

	ghelpers.MethodSignatures["java/lang/System.exit(I)V"] = // shutdown the app
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  systemExitI,
		}

	ghelpers.MethodSignatures["java/lang/System.gc()V"] = // for a GC cycle
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  systemForceGC,
		}

	ghelpers.MethodSignatures["java/lang/System.getenv()Ljava/util/Map;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/System.getenv(Ljava/lang/String;)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
	...
	ghelpers.MethodSignatures["java/lang/System.getProperties()Ljava/util/Properties;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  SystemGetProperties,
		}

	ghelpers.MethodSignatures["java/lang/System.getProperty(Ljava/lang/String;)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  SystemGetProperty,
		}

	ghelpers.MethodSignatures["java/lang/System.getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  SystemGetProperty,
		}

	ghelpers.MethodSignatures["java/lang/System.getSecurityManager()Ljava/lang/SecurityManager;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
	...
	ghelpers.MethodSignatures["java/lang/System.inheritedChannel()Ljava/nio/channels/Channel;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/System.lineSeparator()Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  systemLineSeparator,
		}

	ghelpers.MethodSignatures["java/lang/System.load(Ljava/lang/String;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/System.loadLibrary(Ljava/lang/String;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/System.mapLibraryName(Ljava/lang/String;)Ljava/lang/String;"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapFunction,
		}

	ghelpers.MethodSignatures["java/lang/System.nanoTime()J"] = // get nanoseconds time, returned as long
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  systemNanoTime,
		}

	ghelpers.MethodSignatures["java/lang/System.registerNatives()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
			GFunction:  ghelpers.JustReturn,
		}

	ghelpers.MethodSignatures["java/lang/System.runFinalization()V"] =
		ghelpers.GMeth{
			ParamSlots: 0,
	...
	ghelpers.MethodSignatures["java/lang/System.setProperty(Ljava/lang/String;Ljava/lang/String;)V"] =
		ghelpers.GMeth{
			ParamSlots: 2,
			GFunction:  systemSetProperty,
		}

	ghelpers.MethodSignatures["java/lang/System.setSecurityManager(Ljava/lang/SecurityManager;)V"] =
		ghelpers.GMeth{
			ParamSlots: 1,
			GFunction:  ghelpers.TrapDeprecated,
		}
...
func systemArrayCopy(params []interface{}) interface{} {
	...
	if !strings.HasPrefix(destType, types.Array) || srcType != destType {
		...
		return ghelpers.GetGErrBlk(excNames.ArrayStoreException, errMsg)
	}
...
func systemSetProperties(params []interface{}) interface{} {
	...
	newMap := propertiesObj.FieldTable[types.FieldNameProperties].Fvalue.(types.DefProperties)
