...
func TestStringClinit(t *testing.T) {
	...
	if retval != nil {
		...
		case *ghelpers.GErrBlk:
			gErr := retval.(*ghelpers.GErrBlk)
			t.Errorf("TestStringClinit: Unexpected ghelpers.GErrBlk error message. got %s", gErr.ErrMsg)
			return
		case *object.Object:
...
func TestStringSplitLimit(t *testing.T) {
	...
	errBlk := stringSplitLimit(params).(*ghelpers.GErrBlk)
	if errBlk == nil {
