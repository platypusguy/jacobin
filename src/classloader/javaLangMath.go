...
func Load_Lang_Math() map[string]GMeth {
	...
	MethodSignatures["java/lang/Math.copySign(DD)D"] = GMeth{ParamSlots: 4, GFunction: copySignFloat64}
	...
	MethodSignatures["java/lang/Math.fma(DDD)D"] = GMeth{ParamSlots: 6, GFunction: fmaFloat64}
	...
	MethodSignatures["java/lang/Math.max(DD)D"] = GMeth{ParamSlots: 4, GFunction: maxFloat64}
	...
	MethodSignatures["java/lang/Math.max(JJ)J"] = GMeth{ParamSlots: 4, GFunction: maxInt64}
	MethodSignatures["java/lang/Math.min(DD)D"] = GMeth{ParamSlots: 4, GFunction: minFloat64}
	...
	MethodSignatures["java/lang/Math.min(JJ)J"] = GMeth{ParamSlots: 4, GFunction: minInt64}
	MethodSignatures["java/lang/Math.multiplyExact(II)I"] = GMeth{ParamSlots: 2, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/Math.multiplyExact(JI)I"] = GMeth{ParamSlots: 3, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/Math.multiplyExact(JJ)J"] = GMeth{ParamSlots: 4, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/Math.multiplyHigh(JJ)J"] = GMeth{ParamSlots: 4, GFunction: multiplyHighInt64}
	...
	MethodSignatures["java/lang/Math.nextAfter(DD)D"] = GMeth{ParamSlots: 4, GFunction: nextAfterFloat64}
	MethodSignatures["java/lang/Math.nextAfter(FD)F"] = GMeth{ParamSlots: 3, GFunction: nextAfterFloat64}
	...
	MethodSignatures["java/lang/Math.scaleb(DI)D"] = GMeth{ParamSlots: 3, GFunction: scalebFloat64}
	...
	MethodSignatures["java/lang/Math.subtractExact(JJ)J"] = GMeth{ParamSlots: 4, GFunction: subtractExactInt64}
	...
	MethodSignatures["java/lang/StrictMath.copySign(DD)D"] = GMeth{ParamSlots: 4, GFunction: copySignFloat64}
	...
	MethodSignatures["java/lang/StrictMath.fma(DDD)D"] = GMeth{ParamSlots: 6, GFunction: fmaFloat64}
	...
	MethodSignatures["java/lang/StrictMath.max(DD)D"] = GMeth{ParamSlots: 4, GFunction: maxFloat64}
	...
	MethodSignatures["java/lang/StrictMath.max(JJ)J"] = GMeth{ParamSlots: 4, GFunction: maxInt64}
	MethodSignatures["java/lang/StrictMath.min(DD)D"] = GMeth{ParamSlots: 4, GFunction: minFloat64}
	...
	MethodSignatures["java/lang/StrictMath.min(JJ)J"] = GMeth{ParamSlots: 4, GFunction: minInt64}
	MethodSignatures["java/lang/StrictMath.multiplyExact(II)I"] = GMeth{ParamSlots: 2, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/StrictMath.multiplyExact(JI)I"] = GMeth{ParamSlots: 3, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/StrictMath.multiplyExact(JJ)J"] = GMeth{ParamSlots: 4, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/StrictMath.multiplyHigh(JJ)J"] = GMeth{ParamSlots: 4, GFunction: multiplyHighInt64}
	...
	MethodSignatures["java/lang/StrictMath.nextAfter(DD)D"] = GMeth{ParamSlots: 4, GFunction: nextAfterFloat64}
	MethodSignatures["java/lang/StrictMath.nextAfter(FD)F"] = GMeth{ParamSlots: 3, GFunction: nextAfterFloat64}
	...
	MethodSignatures["java/lang/StrictMath.scaleb(DI)D"] = GMeth{ParamSlots: 3, GFunction: scalebFloat64}
	...
	MethodSignatures["java/lang/StrictMath.subtractExact(JJ)J"] = GMeth{ParamSlots: 4, GFunction: subtractExactInt64}
