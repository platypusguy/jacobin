...
func Load_Lang_Math() map[string]GMeth {
	...
	MethodSignatures["java/lang/Math.addExact(II)I"] = GMeth{ParamSlots: 2, GFunction: addExactInt64}
	MethodSignatures["java/lang/Math.addExact(JJ)J"] = GMeth{ParamSlots: 2, GFunction: addExactInt64}
	...
	MethodSignatures["java/lang/Math.copySign(DD)D"] = GMeth{ParamSlots: 2, GFunction: copySignFloat64}
	MethodSignatures["java/lang/Math.copySign(FF)F"] = GMeth{ParamSlots: 2, GFunction: copySignFloat64}
	...
	MethodSignatures["java/lang/Math.floorDiv(II)I"] = GMeth{ParamSlots: 2, GFunction: floorDivInt64}
	MethodSignatures["java/lang/Math.floorDiv(JI)J"] = GMeth{ParamSlots: 2, GFunction: floorDivInt64}
	MethodSignatures["java/lang/Math.floorDiv(JJ)J"] = GMeth{ParamSlots: 2, GFunction: floorDivInt64}
	MethodSignatures["java/lang/Math.floorMod(II)I"] = GMeth{ParamSlots: 2, GFunction: floorModInt64}
	MethodSignatures["java/lang/Math.floorMod(JI)J"] = GMeth{ParamSlots: 2, GFunction: floorModInt64}
	MethodSignatures["java/lang/Math.floorMod(JJ)J"] = GMeth{ParamSlots: 2, GFunction: floorModInt64}
	MethodSignatures["java/lang/Math.fma(DDD)D"] = GMeth{ParamSlots: 3, GFunction: fmaFloat64}
	MethodSignatures["java/lang/Math.fma(FFF)F"] = GMeth{ParamSlots: 3, GFunction: fmaFloat64}
	...
	MethodSignatures["java/lang/Math.max(DD)D"] = GMeth{ParamSlots: 2, GFunction: maxFloat64}
	MethodSignatures["java/lang/Math.max(FF)F"] = GMeth{ParamSlots: 2, GFunction: maxFloat64}
	MethodSignatures["java/lang/Math.max(II)I"] = GMeth{ParamSlots: 2, GFunction: maxInt64}
	MethodSignatures["java/lang/Math.max(JJ)J"] = GMeth{ParamSlots: 2, GFunction: maxInt64}
	MethodSignatures["java/lang/Math.min(DD)D"] = GMeth{ParamSlots: 2, GFunction: minFloat64}
	MethodSignatures["java/lang/Math.min(FF)F"] = GMeth{ParamSlots: 2, GFunction: minFloat64}
	MethodSignatures["java/lang/Math.min(II)I"] = GMeth{ParamSlots: 2, GFunction: minInt64}
	MethodSignatures["java/lang/Math.min(JJ)J"] = GMeth{ParamSlots: 2, GFunction: minInt64}
	MethodSignatures["java/lang/Math.multiplyExact(II)I"] = GMeth{ParamSlots: 2, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/Math.multiplyExact(JI)I"] = GMeth{ParamSlots: 2, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/Math.multiplyExact(JJ)J"] = GMeth{ParamSlots: 2, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/Math.multiplyHigh(JJ)J"] = GMeth{ParamSlots: 2, GFunction: multiplyHighInt64}
	...
	MethodSignatures["java/lang/Math.nextAfter(DD)D"] = GMeth{ParamSlots: 2, GFunction: nextAfterFloat64}
	MethodSignatures["java/lang/Math.nextAfter(FD)F"] = GMeth{ParamSlots: 2, GFunction: nextAfterFloat64}
	...
	MethodSignatures["java/lang/Math.pow(D)D"] = GMeth{ParamSlots: 1, GFunction: powFloat64}
	...
	MethodSignatures["java/lang/Math.scaleb(DI)D"] = GMeth{ParamSlots: 2, GFunction: scalebFloat64}
	MethodSignatures["java/lang/Math.scaleb(FI)F"] = GMeth{ParamSlots: 2, GFunction: scalebFloat64}
	...
	MethodSignatures["java/lang/Math.subtractExact(II)I"] = GMeth{ParamSlots: 2, GFunction: subtractExactInt64}
	MethodSignatures["java/lang/Math.subtractExact(JJ)J"] = GMeth{ParamSlots: 2, GFunction: subtractExactInt64}
	...
	MethodSignatures["java/lang/StrictMath.addExact(II)I"] = GMeth{ParamSlots: 2, GFunction: addExactInt64}
	MethodSignatures["java/lang/StrictMath.addExact(JJ)J"] = GMeth{ParamSlots: 2, GFunction: addExactInt64}
	...
	MethodSignatures["java/lang/StrictMath.copySign(DD)D"] = GMeth{ParamSlots: 2, GFunction: copySignFloat64}
	MethodSignatures["java/lang/StrictMath.copySign(FF)F"] = GMeth{ParamSlots: 2, GFunction: copySignFloat64}
	...
	MethodSignatures["java/lang/StrictMath.floorDiv(II)I"] = GMeth{ParamSlots: 2, GFunction: floorDivInt64}
	MethodSignatures["java/lang/StrictMath.floorDiv(JI)J"] = GMeth{ParamSlots: 2, GFunction: floorDivInt64}
	MethodSignatures["java/lang/StrictMath.floorDiv(JJ)J"] = GMeth{ParamSlots: 2, GFunction: floorDivInt64}
	MethodSignatures["java/lang/StrictMath.floorMod(II)I"] = GMeth{ParamSlots: 2, GFunction: floorModInt64}
	MethodSignatures["java/lang/StrictMath.floorMod(JI)J"] = GMeth{ParamSlots: 2, GFunction: floorModInt64}
	MethodSignatures["java/lang/StrictMath.floorMod(JJ)J"] = GMeth{ParamSlots: 2, GFunction: floorModInt64}
	MethodSignatures["java/lang/StrictMath.fma(DDD)D"] = GMeth{ParamSlots: 3, GFunction: fmaFloat64}
	MethodSignatures["java/lang/StrictMath.fma(FFF)F"] = GMeth{ParamSlots: 3, GFunction: fmaFloat64}
	...
	MethodSignatures["java/lang/StrictMath.max(DD)D"] = GMeth{ParamSlots: 2, GFunction: maxFloat64}
	MethodSignatures["java/lang/StrictMath.max(FF)F"] = GMeth{ParamSlots: 2, GFunction: maxFloat64}
	MethodSignatures["java/lang/StrictMath.max(II)I"] = GMeth{ParamSlots: 2, GFunction: maxInt64}
	MethodSignatures["java/lang/StrictMath.max(JJ)J"] = GMeth{ParamSlots: 2, GFunction: maxInt64}
	MethodSignatures["java/lang/StrictMath.min(DD)D"] = GMeth{ParamSlots: 2, GFunction: minFloat64}
	MethodSignatures["java/lang/StrictMath.min(FF)F"] = GMeth{ParamSlots: 2, GFunction: minFloat64}
	MethodSignatures["java/lang/StrictMath.min(II)I"] = GMeth{ParamSlots: 2, GFunction: minInt64}
	MethodSignatures["java/lang/StrictMath.min(JJ)J"] = GMeth{ParamSlots: 2, GFunction: minInt64}
	MethodSignatures["java/lang/StrictMath.multiplyExact(II)I"] = GMeth{ParamSlots: 2, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/StrictMath.multiplyExact(JI)I"] = GMeth{ParamSlots: 2, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/StrictMath.multiplyExact(JJ)J"] = GMeth{ParamSlots: 2, GFunction: multiplyExactInt64}
	MethodSignatures["java/lang/StrictMath.multiplyHigh(JJ)J"] = GMeth{ParamSlots: 2, GFunction: multiplyHighInt64}
	...
	MethodSignatures["java/lang/StrictMath.nextAfter(DD)D"] = GMeth{ParamSlots: 2, GFunction: nextAfterFloat64}
	MethodSignatures["java/lang/StrictMath.nextAfter(FD)F"] = GMeth{ParamSlots: 2, GFunction: nextAfterFloat64}
	...
	MethodSignatures["java/lang/StrictMath.pow(D)D"] = GMeth{ParamSlots: 1, GFunction: powFloat64}
	...
	MethodSignatures["java/lang/StrictMath.scaleb(DI)D"] = GMeth{ParamSlots: 2, GFunction: scalebFloat64}
	MethodSignatures["java/lang/StrictMath.scaleb(FI)F"] = GMeth{ParamSlots: 2, GFunction: scalebFloat64}
	...
	MethodSignatures["java/lang/StrictMath.subtractExact(II)I"] = GMeth{ParamSlots: 2, GFunction: subtractExactInt64}
	MethodSignatures["java/lang/StrictMath.subtractExact(JJ)J"] = GMeth{ParamSlots: 2, GFunction: subtractExactInt64}
...
func addExactInt64(params []interface{}) interface{} {
...
func copySignFloat64(params []interface{}) interface{} {
...
func floorDivInt64(params []interface{}) interface{} {
...
func floorModInt64(params []interface{}) interface{} {
	fldiv := (floorDivInt64(params)).(int64)
...
func fmaFloat64(params []interface{}) interface{} {
	a := params[0].(float64)
	b := params[1].(float64)
	c := params[2].(float64)
...
// Maximum of 2 floats or doubles.
func maxFloat64(params []interface{}) interface{} {
	return math.Max(params[0].(float64), params[1].(float64))
}

// Maximum of 2 ints or longs.
func maxInt64(params []interface{}) interface{} {
	x := params[0].(int64)
	y := params[0].(int64)
	if x > y {
		return x
...
// Minimum of 2 floats or doubles.
func minFloat64(params []interface{}) interface{} {
	return math.Min(params[0].(float64), params[1].(float64))
}

// Minimum of 2 ints or longs.
func minInt64(params []interface{}) interface{} {
	x := params[0].(int64)
	y := params[0].(int64)
	if x < y {
		return x
...
func multiplyExactInt64(params []interface{}) interface{} {
	return params[0].(int64) * params[1].(int64)
}

// Most significant 64 bits of the 128-bit product of two 64-bit factors.
func multiplyHighInt64(params []interface{}) interface{} {
	x := params[0].(int64)
	y := params[0].(int64)
	shift := 63
	mask := int64(1 << shift)
...
func nextAfterFloat64(params []interface{}) interface{} {
...
func scalebFloat64(params []interface{}) interface{} {
	x := params[0].(float64)
...
func subtractExactInt64(params []interface{}) interface{} {
