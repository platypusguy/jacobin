...
func Load_Lang_Math() map[string]GMeth {
	...
	MethodSignatures["java/lang/Math.addExact(JJ)J"] = GMeth{ParamSlots: 4, GFunction: addExactInt64}
	...
	MethodSignatures["java/lang/Math.floorDiv(JI)J"] = GMeth{ParamSlots: 3, GFunction: floorDivInt64}
	MethodSignatures["java/lang/Math.floorDiv(JJ)J"] = GMeth{ParamSlots: 4, GFunction: floorDivInt64}
	MethodSignatures["java/lang/Math.floorMod(II)I"] = GMeth{ParamSlots: 2, GFunction: floorModInt64}
	MethodSignatures["java/lang/Math.floorMod(JI)J"] = GMeth{ParamSlots: 3, GFunction: floorModInt64}
	MethodSignatures["java/lang/Math.floorMod(JJ)J"] = GMeth{ParamSlots: 4, GFunction: floorModInt64}
	...
	MethodSignatures["java/lang/StrictMath.addExact(JJ)J"] = GMeth{ParamSlots: 4, GFunction: addExactInt64}
	...
	MethodSignatures["java/lang/StrictMath.floorDiv(JI)J"] = GMeth{ParamSlots: 3, GFunction: floorDivInt64}
	MethodSignatures["java/lang/StrictMath.floorDiv(JJ)J"] = GMeth{ParamSlots: 4, GFunction: floorDivInt64}
	MethodSignatures["java/lang/StrictMath.floorMod(II)I"] = GMeth{ParamSlots: 2, GFunction: floorModInt64}
	MethodSignatures["java/lang/StrictMath.floorMod(JI)J"] = GMeth{ParamSlots: 3, GFunction: floorModInt64}
	MethodSignatures["java/lang/StrictMath.floorMod(JJ)J"] = GMeth{ParamSlots: 4, GFunction: floorModInt64}
